...
namespace ispring {
	...
	*/
	...
	public:
		...
		*/
		static bool PtInTriangle(cv::Point pt, cv::Point t1, cv::Point t2, cv::Point t3) {
			bool b1, b2, b3;
			b1 = InOrOut(pt, t1, t2);
			b2 = InOrOut(pt, t2, t3);
			b3 = InOrOut(pt, t3, t1);
		...
		*/
		static bool PtInRectangle(cv::Point pt, cv::Point t1, cv::Point t2, cv::Point t3, cv::Point t4) {
			bool b1, b2;
