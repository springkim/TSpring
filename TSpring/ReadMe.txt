================================================================================
    MFC 라이브러리 : TSpring 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 TSpring 응용 프로그램을 만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램을 작성하기 위한 기본 구조를 제공합니다.

TSpring 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
TSpring.h
    ...
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 CTSpringApp 응용 프로그램 클래스가 선언되어 있습니다.

TSpring.cpp
    이는 응용 프로그램 클래스 CTSpringApp가 포함된 기본 응용 프로그램 소스 파일입니다.
...
res\TSpring.ico
    아이콘 파일이며, 응용 프로그램의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 TSpring.rc에 의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 TSpring.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
